...
/**
 *  <h1>EliteRising</h1>
 *  <p>EliteRising <span style="font-weight:bold">v1.4</span> lava rising package. (EN/TR)
...
public final class EliteRising extends JavaPlugin {
    ...
    public static ArrayList<HashMap<String,ArrayList<String>>> CUSTOM_GAME_MODES = new ArrayList<>();
    public static Version VERSION = new Version("1.4");
    ...
    public static ArrayList<String> getStartModesName() {
        ...
        for (HashMap<String,ArrayList<String>> h : CUSTOM_GAME_MODES) {
            res.add(removeFirstLastValues(String.valueOf(Collections.singletonList(h.keySet()).get(0))));
        }
        return res;
    }
